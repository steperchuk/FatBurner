...
public class MealCalendar extends FragmentActivity {
    ...
    private void ShowInfoDialog(){
        ...
        exerciseLabel.setText(
                "1. Вам необходимо сохранить настройки для каждого дня по отдельности.\n\n" +
                ...
                "4. Формулы для выбора продуктов подобраны для распределения баланса беков, жиров и углеводов в вашем рационе.\n\n" +
                "5. Выбраные продукты будут отображены в меню 'Диета' где вы сможете следить за питанием и организовать покупку только необходимого количества продуктов.\n"
        );
